# VK Checker API — official examples | eKYC Pro

This repository documents the eKYC Pro VK Checker API integration contract using facts from the expansion manifest.

- Product page: https://ekycpro.com/tools/vk
...
```bash
curl -X POST "https://api.ekycpro.com/v1/check" -H "X-API-Key: ${EKYCPRO_API_KEY}" -H "Content-Type: application/json" -d '{"service_type":"vk","identifier":"+14155550100"}'
```
...
| --- | --- | --- | --- | --- | --- |
| `vk` | VK Checker | phone | 1–1 identifier | `id, identifier, registered, billed, cost, cost_usd` | [docs](https://docs.ekycpro.com/vk-checker) |
...
- `vk`: https://docs.ekycpro.com/vk-checker
